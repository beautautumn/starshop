...
@Component("shoppingCartSettlementClientSpringCloudAdapter")
@AllArgsConstructor
public class ShoppingCartSettlementClientSpringCloutAdapter implements ShoppingCartSettlementClient {
